/** Sync SHA-256 (hex). No WebCrypto dependency — works in all service paths. */
...
export function sha256Hex(input: string | Uint8Array): string {
  ...
  // length as 64-bit big-endian (we only need low 32 for practical sizes)
...
/** Canonical evidence digest — stable field order. */
export function evidenceHash(parts: Record<string, string | number | undefined | null>): string {
